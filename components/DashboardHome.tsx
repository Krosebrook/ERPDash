        ...
        <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-xl p-4 md:p-6 shadow-xl">
          ...
          <div className="h-48 md:h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={chartData} onMouseMove={(s) => s.activeTooltipIndex !== undefined && typeof s.activeTooltipIndex === 'number' && setHoveredBar(s.activeTooltipIndex)} onMouseLeave={() => setHoveredBar(null)}>
