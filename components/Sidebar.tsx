...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, userRole, onRoleChange }) => {
  const navItems = [
  ...
  return (
    <aside className="w-64 border-r border-slate-800 flex flex-col bg-slate-900 z-20">
      <div className="p-6">
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="font-bold text-xl tracking-tight">INT INC</span>
        </div>
      ...
      <div className="mt-auto p-6 border-t border-slate-800">
        <label className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3 block">Switch Role</label>
