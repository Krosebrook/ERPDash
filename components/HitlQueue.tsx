  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-right duration-500">
      ...
      <div className="space-y-4">
        {requests.map((req) => (
          <div key={req.id} className="bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-blue-500/50 transition-all group animate-in zoom-in-95">
            ...
            <div className="flex gap-2">
              <Tooltip content="Authorize this request and resume agent execution">
                <button 
                  ...
                  className="px-4 py-2 bg-green-600 hover:bg-green-500 text-white rounded-lg text-sm font-bold transition-colors shadow-lg shadow-green-600/10"
                >
                  Approve
                </button>
              </Tooltip>
              <Tooltip content="Deny request and terminate current agent session">
                <button 
                  ...
                  className="px-4 py-2 bg-red-600 hover:bg-red-500 text-white rounded-lg text-sm font-bold transition-colors shadow-lg shadow-red-600/10"
                >
                  Reject
                </button>
              </Tooltip>
